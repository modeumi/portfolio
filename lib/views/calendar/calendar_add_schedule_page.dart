...
class CalendarAddSchedulePage extends ConsumerStatefulWidget {
  ...
  const CalendarAddSchedulePage({super.key, required this.previous});
                                      ...
                                      calendarBuilders: CalendarBuilders(
                                        dowBuilder: (context, day) {
                                          switch (day.weekday) {
                                            ...
                                            default:
                                              return Center(
                                                child: Text(['월', '화', '수', '목', '금'][day.weekday - 1], style: black(14, FontWeight.w400)),
                                              );
                                          }
                                        },
                                        defaultBuilder: (context, day, focusedDay) {
                                          return calendarDaySelectBuild(
                                            day,
                                            calendarState.schedule.startDate!,
                                            calendarState.schedule.endDate!,
                                            false,
                                          );
                                        },
